...
*Ghi chú: Nội dung chi tiết về sơ đồ Use Case, biểu đồ Class, Sequence Diagram, sơ đồ ERD thiết kế cơ sở dữ liệu được đặc tả chi tiết trong các tài liệu chuyên biệt đi kèm đồ án (Tài liệu SRS, Use Case Specification, Sơ đồ Sequence Diagrams) và không thuộc phạm vi xử lý trực tiếp của phần báo cáo này.*
